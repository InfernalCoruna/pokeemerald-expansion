...
const u16 gMetatiles_Connor[] = INCBIN_U16("data/tilesets/primary/connor/metatiles.bin");
const u16 gMetatileAttributes_Connor[] = INCBIN_U16("data/tilesets/primary/connor/metatile_attributes.bin");

const u16 gMetatiles_Connorsecondary[] = INCBIN_U16("data/tilesets/secondary/connorsecondary/metatiles.bin");
const u16 gMetatileAttributes_Connorsecondary[] = INCBIN_U16("data/tilesets/secondary/connorsecondary/metatile_attributes.bin");
