...
#define VAR_GIANT_CHASM_STATE                            0x404E // 
...
#define DN_VAR_SPECIES                0x4055 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           0x4056 // Steps for finding hidden pokemon
